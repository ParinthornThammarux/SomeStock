# utils/constants.py - Streamlit Configuration & UI Constants
# NO DearPyGUI dependencies - UI-agnostic configuration only

import os
from pathlib import Path

VERSION = "v2.0.0 - Streamlit Migration"
DEBUG = True

# --- Font Awesome Icon Setup ---
# Note: Streamlit uses Unicode emoji and HTML rendering
# Font Awesome TTF file no longer required
FONT_AWESOME_PATH = 'fa-solid-900.ttf'  # Kept for reference, not used
...
# --- Layout & Organization (Removed DearPyGUI Animation Parameters) ---
ICON_TH = "\uf00a"          # Grid (3x3)
...
# Note: Window size, animations are handled by Streamlit's responsive design
# No fixed window dimensions needed

def load_fonts():
    """Stub function - fonts handled by Streamlit rendering engine"""
    pass